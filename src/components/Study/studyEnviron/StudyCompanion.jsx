  ...
  return (
    <aside className="w-full self-start lg:sticky lg:top-6">
      <div className="flex flex-col gap-4 lg:items-stretch">
        <div className="mt-[30px] flex min-h-[19rem] w-full flex-1 flex-col overflow-hidden rounded-2xl border border-green-200/50 bg-transparent p-5 shadow-none dark:border-slate-700/50">
