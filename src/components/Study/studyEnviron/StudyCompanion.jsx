  ...
  return (
    <aside className="w-full self-start">
      <div className="flex flex-col gap-4 lg:items-stretch">
        <div className="flex min-h-[19rem] w-full flex-1 flex-col overflow-hidden rounded-2xl border border-green-200/50 bg-transparent p-5 shadow-none dark:border-slate-700/50">
