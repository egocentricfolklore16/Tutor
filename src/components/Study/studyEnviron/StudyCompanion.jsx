  ...
  return (
    <aside className="w-full self-start">
      <div className="flex flex-col gap-4 lg:items-stretch">
        <div className="flex min-h-[19rem] w-full flex-1 flex-col overflow-hidden rounded-2xl border border-green-200 bg-gradient-to-b from-green-50 via-white to-amber-50 p-5 shadow-sm dark:border-slate-700 dark:from-green-900/20 dark:via-[#18211f] dark:to-amber-900/10">
