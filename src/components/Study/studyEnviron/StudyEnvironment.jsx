...
const StudyEnvironment = ({ session: incomingSession, user: incomingUser }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <main
      className={`min-w-0 px-3 py-4 pb-24 sm:px-5 md:px-6 xl:px-10 transition-all duration-300 ${   isToolsOpen     ? "xl:ml-[calc(var(--app-sidebar-width,0px)+300px)]"     : "xl:ml-[calc(var(--app-sidebar-width,0px)+64px)]" } ${
